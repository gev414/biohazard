    ...
    public static void render(
        ...
        graphics.drawCenteredString(
                ...
                Component.translatable(
                        expanded
                                ? "screen.rotwire.city_status.tab.close"
                                : "screen.rotwire.city_status.tab.open"
                ),
                (tabLeft + tabRight) / 2,
                panelTop + 6,
                0xD8EED3
        ...
        graphics.drawCenteredString(
                MinecraftFonts.font(graphics),
                Component.translatable(
                        "screen.rotwire.city_status.compact_title"
                ),
        ...
        if (!status.mapped()) {
            graphics.drawString(
                    MinecraftFonts.font(graphics),
                    Component.translatable(
                            "screen.rotwire.city_status.none.line1"
                    ),
                    textLeft,
                    line,
                    0xD6BDA6,
            ...
            graphics.drawString(
                    MinecraftFonts.font(graphics),
                    Component.translatable(
                            "screen.rotwire.city_status.none.line2"
                    ),
                    textLeft,
                    line + 16,
                    0xD6BDA6,
        ...
        graphics.drawString(
                MinecraftFonts.font(graphics),
                Component.translatable(
                        "screen.rotwire.city_status.cleared",
        ...
        graphics.drawString(
                MinecraftFonts.font(graphics),
                Component.translatable(
                        "screen.rotwire.city_status.danger",
                        status.dangerLevel(),
        ...
        graphics.drawString(
                MinecraftFonts.font(graphics),
                Component.translatable(
                        "screen.rotwire.city_status.health",
        ...
        graphics.drawString(
                MinecraftFonts.font(graphics),
                Component.translatable(
                        "screen.rotwire.city_status.next",
