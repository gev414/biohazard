...
import io.github.gev414.rotwire.network.SurvivalStatusPayload;
...
public final class InventoryEncumbranceClient {
    ...
    private static List<Component> tooltip(
        ...
        lines.add(tierLine(
                "tooltip.rotwire.encumbrance.burdened",
                1,
                status.tier(),
                formatTenths(status.lightMaximumTenths()),
        ...
        lines.add(tierLine(
                "tooltip.rotwire.encumbrance.heavy",
                2,
                status.tier(),
                formatTenths(status.burdenedMaximumTenths()),
        ...
        lines.add(tierLine(
                "tooltip.rotwire.encumbrance.overloaded",
                3,
                status.tier(),
                formatTenths(status.heavyMaximumTenths()),
        ...
        lines.add(Component.empty());
        lines.add(Component.translatable(
                "tooltip.rotwire.encumbrance.stealth"
    ...
    private static Component tierName(int tier) {
        String key = switch (tier) {
            case 1 -> "hud.rotwire.encumbrance.burdened";
            case 2 -> "hud.rotwire.encumbrance.heavy";
            case 3 -> "hud.rotwire.encumbrance.overloaded";
            default -> "hud.rotwire.encumbrance.light";
        };
