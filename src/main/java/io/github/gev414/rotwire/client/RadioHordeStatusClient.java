    ...
    public static void render(Screen screen, GuiGraphics graphics) {
        ...
        graphics.drawCenteredString(
                ...
                Component.translatable(
                        "screen.rotwire.radio_horde.title"
                ),
                (left + right) / 2,
                top + 5,
                0xD8EED3
        ...
        graphics.drawString(
                minecraft.font,
                Component.translatable(
                        "screen.rotwire.radio_horde.day",
                        Component.translatable(
                                state.hordeDay()
                                        ? "screen.rotwire.radio_horde.yes"
                                        : "screen.rotwire.radio_horde.no"
                        )
                ),
                left + 8,
                top + 25,
        ...
        graphics.drawString(
                ...
                Component.translatable(
                        state.active()
                                ? "screen.rotwire.radio_horde.active"
                                : "screen.rotwire.radio_horde.inactive"
                ),
                left + 8,
                top + 39,
        ...
        graphics.drawString(
                minecraft.font,
                Component.translatable(
                        "screen.rotwire.radio_horde.time",
